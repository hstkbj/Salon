        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    <h1 class="text-color-primary font-weight-bold">Lorem ipsum dolor sit a met, consectetur</h1>
                </div>
                        ...
                        <div class="card border-0">
                            <div class="card-body z-index-1 p-0">
                                ...
                                <div class="post-image pb-4">
                                    <img class="card-img-top" src="../../../../public/img/demos/beauty-salon/blog/blog-post.jpg" alt="Card Image">
                                </div>
                                    ...
                                    <div class="post-block post-author">
                                        ...
                                        <div class="img-thumbnail img-thumbnail-no-borders d-block pb-3">
                                            <a href="blog-post.html">
                                                <img src="../../../../public/img/avatars/avatar.jpg" class="rounded-circle" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div id="comments" class="post-block post-comments">
                                        ...
                                        <ul class="comments">
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block">
                                                        <img class="avatar rounded-circle" alt="" src="../../../../public/img/avatars/avatar-2.jpg">
                                                    </div>
                                                ...
                                                <ul class="comments reply">
                                                    <li>
                                                        <div class="comment">
                                                            <div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block">
                                                                <img class="avatar rounded-circle" alt="" src="../../../../public/img/avatars/avatar-3.jpg">
                                                            </div>
                                                            <div class="comment-block">
                                                                <div class="comment-arrow"></div>
                                                                <span class="comment-by">
                                                    ...
                                                    <li>
                                                        <div class="comment">
                                                            <div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block">
                                                                <img class="avatar rounded-circle" alt="" src="../../../../public/img/avatars/avatar-4.jpg">
                                                            </div>
                                                            <div class="comment-block">
                                                                <div class="comment-arrow"></div>
                                                                <span class="comment-by">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block">
                                                        <img class="avatar rounded-circle" alt="" src="../../../../public/img/avatars/avatar.jpg">
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-arrow"></div>
                                                        <span class="comment-by">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col">
                                                        ...
                                                        <textarea maxlength="5000" data-msg-required="Please enter your message." rows="8" class="form-control px-3 border-0 box-shadow-none py-3" name="message" id="message" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
